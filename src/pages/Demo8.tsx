/**
 * Demo8: AI Smart Chat Assistant
 * Original homepage functionality - AI chat with analysis canvas
 */
      ...
      <div className="border-b border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 shadow-sm p-4">
        <div className="flex items-center justify-between max-w-6xl mx-auto">
          <div className="flex items-center gap-4">
            <h1 className="text-xl font-bold text-slate-900 dark:text-slate-100">Demo 8: AI Smart Chat Assistant</h1>
            <BackToHome />
            <Button
